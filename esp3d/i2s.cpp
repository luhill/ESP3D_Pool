  ...
  while (1) {
    ...
    while (dma.rw_pos < DMA_SAMPLE_COUNT) {
      ...
      if (remaining) {
        ...
        //remaining = Stepper::block_phase_isr(); //luke
      }
    }
  }
}
...
int i2s_init() {
  ...
  /*luke to do*///xTaskCreatePinnedToCore(stepperTask, "StepperTask", 10000, nullptr, 1, nullptr, CONFIG_ARDUINO_RUNNING_CORE); // run I2S stepper task on same core as rest of Marlin
  xTaskCreatePinnedToCore(stepperTask,"StepperTask",10000,nullptr,1,nullptr,CONFIG_ARDUINO_RUN_CORE1);
